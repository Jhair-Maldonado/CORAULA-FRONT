...
import { KpiAlumno } from '@/app/administrador/alumnos/component/KpiAlumno';
...
export default function AlumnosDashboard() {
  ...
  return (
    <div className="w-full h-full p-8 md:p-10 overflow-y-auto bg-canvas font-sans flex flex-col gap-6">
      ...
      {/* TOP ROW: KPIS CON EL NUEVO COMPONENTE KpiAlumno */}
      <KpiAlumno 
        totalMatriculados={totalMatriculados}
        asistenciaHoy={asistenciaHoy}
        vacantesDisponibles={allStudents.length > 0 ? 45 : 0}
      />
