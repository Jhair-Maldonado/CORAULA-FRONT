...
import { BloqueHorario } from '@/types/horario';
import { 
  DIAS_SEMANA, 
  HORAS_INICIO_OPCIONES, 
  HORAS_LISTA, 
  CURSOS_CONFIG, 
  MOCK_BLOQUES_HORARIO 
} from '@/data/mockHorario';
...
export default function DetalleHorarioPage() {
  ...
  // Estado inicial de clases en el horario
  const [bloques, setBloques] = useState<BloqueHorario[]>(MOCK_BLOQUES_HORARIO);
